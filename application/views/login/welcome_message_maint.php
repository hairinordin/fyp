            ...
            <div class="container">
                <div id="loginbox" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 loginbox"> 
                    <div class="panel with-nav-tabs panel-info" > 
                        ...
                        <img class="img-responsive" src="<?= base_url() ?>theme1/assets/images/emains_maint.jpg" title="EKAS MIGRATION" alt="Flower">
                    </a>
...
<!--<p style="font-size:1.2em;color:#b1d800;font-weight:bold">The site is best viewed in....</p> -->
                            ...
                            <p><strong>Jabatan Alam Sekitar </strong> <br>Aras 1 - 4, Podium 2 & 3, Wisma Sumber Asli No.25, Persiaran Perdana, Presint 4, <br>Pusat Pentadbiran Kerajaan Persekutuan, 62574 Putrajaya, Malaysia. <br>General Line: 03 - 8871 2000 / 8871 2200 Fax Number : 03 - 8889 1973/75</p>
                            <br>
...
<script>
    ...
    function populate_user(id)
    {
       ...
       // $('#form')[0].reset(); // reset form on modals
        ...
        $.ajax({
            url: "<?php echo site_url('auth/ajax_signup/') ?>" + id,
            type: "GET",
            dataType: "JSON",
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data == 'registered') {
                    ...
                    //console.log(data);
                    console.log('Hel');
                    console.log(data[0].CAWANGAN_JAS);
                    console.log('lo');
...
<!-- ESWIS MODAL-->
<div id="eswisModal-disable" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">EKAS MIGRATION</h4>
            </div>
            <div class="modal-body">
                <p style="text-align:center">
                    ...
                    <a href="" data-dismiss="modal">
                        <img class="img-responsive" src="<?= base_url() ?>theme1/assets/images/ekas_migrate.jpg" title="EKAS MIGRATION" alt="Flower">
                    </a>
                </p>
            </div>
        </div>
