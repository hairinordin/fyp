...
<!--            <li><a href="#step-8">Step 8<br /><small>File Upload</small></a></li>-->
    ...
    <?php
    if ($tool->tool_no == '1') {
        if ($answers2->tool1_justification != '') {
        ...
        if ($answers2->tool2_justification != '') {
        ...
        if ($answers2->tool3_justification != '') {
            ...
            ?>
                                        ...
                                        if ($answers2->tool4_justification != '') {
                                        ...
                                        if ($answers2->tool5_justification != '') {
                                        ...
                                        if ($answers2->tool6_justification != '') {
                                        ...
                                        if ($answers2->tool7_justification != '') {
                                                                        ...
                                                                        <div class="form-group">
                                                                            <table class="table borderless">
                                                                                <tr>
                                                                                    <td class="doestatus-column">
                                                                                          <?php
                                                                                        foreach ($doe_answers as $answer):
                                                                                            if ($quest->id == $answer->id_question) {
                                                                                                echo $answer->doe_status;
                                                                                            }
                                                                                        endforeach;
                                                                                        ?>
                                                                                    </td>
                                                                                ...
                                                                                <tr>
                                                                                    <td colspan="3" class="doestatus-column">
                                                                                        ...
                                                                                        foreach ($doe_answers as $answer):
                                                                                            $adaYes = false;
                                                                                            if ($quest->id == $answer->id_question) {
                                                                                                if($quest->id == 120 || $quest->id == 121 || $quest->id == 122){
                                                                                                  
                                                                                                    if($answer->doe_status == 'Yes'){
                                                                                                        $adaYes = true;
                                                                                                    }
                                                                                                    
                                                                                                    if($adaYes){
                                                                                                      echo $answer->doe_score;   
                                                                                                    }
...
//        }
    ...
    var havebeenAnswered = <?php echo ((site_url('answers/get_reviewed_question_status/') . $emt_id) ? true : false); ?>;
  ...
  function populate_form()
    {
        ...
        $.ajax({
            url: "<?php echo site_url('answers/get_reviewed_question_status/' . $emt_id) ?>",
            type: "GET",
            dataType: "JSON",
            success: function (data)
            {
