...
<div class="col-md-10">
    <legend>LAPORAN PENCAPAIAN SUKUAN TAHUN PEMERIKSAAN LAPANGAN</legend>
    ...
    <table class="table table-bordered table-striped">
        ...
        for ($i = 1; $i <= $q; $i++) :
            ...
            <tr>
                <td><?= $i ?>.</td>
                <td>Suku <?= $i ?> (<?= $m[$i] ?>)</td>
                <td align="center"><a href="<?= base_url() ?>report/qlapangan/<?= $tahun ?>/<?= $i ?>/<?= $sektor ?>"><span class="glyphicon glyphicon-download" style="font-size: 24px"></span></a></td>
