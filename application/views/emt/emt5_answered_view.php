...
<?php
	...
	if(isset($emt5_answers)){

	$date_implement = $emt5_answers->date_implement;

	$comment = $emt5_answers->comment;


		if($emt5_answers->self_assessment == 0){
			$option0 = 'checked';
		}

		elseif ($emt5_answers->self_assessment == 1) {
		 	$option1 = 'checked';
		 } 
		elseif ($emt5_answers->self_assessment == 2) {
			$option2 = 'checked';
		}
		elseif ($emt5_answers->self_assessment == 3) {
			$option3 = 'checked';
		}
		
		elseif ($emt5_answers->self_assessment == 4) {
			$option4 = 'checked';
		}
		
		elseif ($emt5_answers->self_assessment == 5) {
			$option5 = 'checked';
		}
...
<div class="form-group" >
	...
	//print_r($emt5_attachments);
	if(!empty($emt5_attachments)){
		foreach($emt5_attachments as $key => $data){
