...
<?php echo form_open_multipart('emt6/submit/'. $emt_type, $attributes); ?>
...
<?php
	...
	if(isset($emt6_answers)){

	$date_implement = $emt6_answers->date_implement;

	$comment = $emt6_answers->comment;


		if($emt6_answers->self_assessment == 0){
			$option0 = 'checked';
		}

		elseif ($emt6_answers->self_assessment == 1) {
		 	$option1 = 'checked';
		 } 
		elseif ($emt6_answers->self_assessment == 2) {
			$option2 = 'checked';
		}
		elseif ($emt6_answers->self_assessment == 3) {
			$option3 = 'checked';
		}
		
		elseif ($emt6_answers->self_assessment == 4) {
			$option4 = 'checked';
		}
		
		elseif ($emt6_answers->self_assessment == 5) {
			$option5 = 'checked';
		}
...
<div class="form-group" >
	...
	//print_r($emt6_attachments);
	if(!empty($emt6_attachments)){
		foreach($emt6_attachments as $key => $data){
