...
<?php echo form_open_multipart('emt4/submit/'. $emt_type, $attributes); ?>
...
<?php
	...
	if(isset($emt4_answers)){

	$date_implement = $emt4_answers->date_implement;

	$comment = $emt4_answers->comment;


		if($emt4_answers->self_assessment == 0){
			$option0 = 'checked';
		}

		elseif ($emt4_answers->self_assessment == 1) {
		 	$option1 = 'checked';
		 } 
		elseif ($emt4_answers->self_assessment == 2) {
			$option2 = 'checked';
		}
		elseif ($emt4_answers->self_assessment == 3) {
			$option3 = 'checked';
		}
		
		elseif ($emt4_answers->self_assessment == 4) {
			$option4 = 'checked';
		}
		
		elseif ($emt4_answers->self_assessment == 5) {
			$option5 = 'checked';
		}
...
<div class="form-group" >
	...
	//print_r($emt4_attachments);
	if(!empty($emt4_attachments)){
		foreach($emt4_attachments as $key => $data){
