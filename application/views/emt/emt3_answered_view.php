...
<?php
	...
	if(isset($emt3_answers)){

	$date_implement = $emt3_answers->date_implement;

	$comment = $emt3_answers->comment;


		if($emt3_answers->self_assessment == 0){
			$option0 = 'checked';
		}

		elseif ($emt3_answers->self_assessment == 1) {
		 	$option1 = 'checked';
		 } 
		elseif ($emt3_answers->self_assessment == 2) {
			$option2 = 'checked';
		}
		elseif ($emt3_answers->self_assessment == 3) {
			$option3 = 'checked';
		}
		
		elseif ($emt3_answers->self_assessment == 4) {
			$option4 = 'checked';
		}
		
		elseif ($emt3_answers->self_assessment == 5) {
			$option5 = 'checked';
		}
...
<div class="form-group" >
	...
	//print_r($emt3_attachments);
	if(!empty($emt3_attachments)){
		foreach($emt3_attachments as $key => $data){
