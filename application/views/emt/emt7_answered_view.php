...
<?php echo form_open_multipart('emt7/submit/'. $emt_type, $attributes); ?>
...
<?php
	...
	if(isset($emt7_answers)){

	$date_implement = $emt7_answers->date_implement;

	$comment = $emt7_answers->comment;


		if($emt7_answers->self_assessment == 0){
			$option0 = 'checked';
		}

		elseif ($emt7_answers->self_assessment == 1) {
		 	$option1 = 'checked';
		 } 
		elseif ($emt7_answers->self_assessment == 2) {
			$option2 = 'checked';
		}
		elseif ($emt7_answers->self_assessment == 3) {
			$option3 = 'checked';
		}
		
		elseif ($emt7_answers->self_assessment == 4) {
			$option4 = 'checked';
		}
		
		elseif ($emt7_answers->self_assessment == 5) {
			$option5 = 'checked';
		}
...
<div class="form-group" >
	...
	//print_r($emt7_attachments);
	if(!empty($emt7_attachments)){
		foreach($emt7_attachments as $key => $data){
...
<li>
<a href="<?php echo base_url() .$data['attachment_link']?> " target="_blank"><?php echo $filename[3]?></a>
