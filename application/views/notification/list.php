...
<div class="row">
    <div class="col-md-12 well">
        <form method="post" action="<?= base_url() ?>notification/">
            ...
            <div class="form-group col-md-3">
                ...
                <a href="<?= base_url('notification/reset/'); ?>" class="btn btn-warning btn-sm" data-toggle="tooltip" title="Reset">Reset</a>
            </div>
        </form>
            ...
            <?php foreach ($premis_berdaftar as $premise): ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="<?= base_url() . 'notification/details/' . $premise->idpremis . '/'. $premise->id ?>">Details</a> 
                        <?php }} ?>
