            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <table id="premise-table-notifications" class=" display table table-bordered table-striped table-hover" style="width:100%">
                        <thead>
                            <tr>
                                <th>Premise</th><th>City</th><th>State</th><th>EMT Submission Type</th><th>Submission Date</th><th>Submission Due Date</th>
                            </tr>
...
//                            return '<a href="<?= base_url()  ?>answers/answers_by_doe/'+data+' ">View answers</a> | \n\
