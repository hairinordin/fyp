                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <table id="premise-table" class=" display table table-bordered table-striped table-hover" style="width:100%">
                            <thead>
                                <tr>
                                    <th>Premise</th><th>City</th><th>State</th><th>Cawangan JAS</th><th>Type</th><th>Date Registered</th><th></th>
                                </tr>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <table id="premise-table-submission" class=" display table table-bordered table-striped table-hover" style="width:100%">
                        <thead>
                            <tr>
                                <th>Premise</th><th>City</th><th>State</th><th>Cawangan JAS</th><th>Type</th><th>EMT Status</th>
                            </tr>
...
<div id="rating" class="tab-pane fade">
    <div class="row-fluid">
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    <div id="container-rating" style="min-width: 500px; height: auto;  text-align: right;"></div>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <table id="premise-table-rating" class=" display table table-bordered table-striped table-hover" style="width:100%">
                        <thead>
                            <tr>
                                <th>Premise</th><th>City</th><th>State</th><th>EMT Status</th><th>Rating</th><th></th>
                            </tr>
...
//            
			...
			var options = {
	            chart: {
	                renderTo: 'container-rating',
	                type: 'column',
	                
	            },
                    
	            title: {
	                text: '<h3>SCORE RATING</h3>',
	                x: 0 //center
	            },
	            subtitle: {
	                text: '',
...
//                    },
	        ...
	        $.getJSON("<?= base_url('kpi/get_premise_registered_chart')?>", function(json) {
			options.xAxis.categories = json[0]['data'];
	        	options.series[0] = json[1];
	        	options.series[1] = json[2];
                        options.series[2] = json[3];
                    ...
                    "columnDefs": [ 
                        ...
                        },
                        {
                            ...
                            "render": function ( data, type, row, meta ) {
                                return '<a href="<?= base_url() ?>premise/manage/'+data+'">Manage</a> ' ;
                                }
                        }    
                      ],            
                });
...
//                      } ]
                ...
                var dt = $('#premise-table-rating').DataTable({
                    "processing" : true,
                    "pageLength" : 10,
                    //"serverSide": true,
                    "lengthMenu": [[10, 25, 50, -1], [10, 25, 50, "All"]],
                    "ajax":{
                        url:"<?php echo site_url("kpi/rating_list/".$this->state) ?>",
                        type:'GET'
                    }, 
                    "dom": '<"dt-buttons"Bf><"clear">lirtp',
			"paging": true,
