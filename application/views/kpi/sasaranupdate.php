<legend>Update KPI</legend>
    ...
    <div class="">
        ...
        <div class="row">
            ...
            <div class="col-md-4"><?= form_dropdown('month', $this->ref->data('month'), $month, "class='form-control' disabled=disabled") ?> </div>
            
            <div class="col-md-2">Tahun</div> 
            <div class="col-md-4"><?= form_dropdown('year', $this->ref->data('year'), $year, "class='form-control' disabled=disabled") ?> </div>  
