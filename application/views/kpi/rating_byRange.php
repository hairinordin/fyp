...
<h3>SCORE RATING REPORT BY DOE 
    (<?= $this->ref->return_state($state_code) ?>) FOR <strong><?= $from_month .' '. $from_year . ' - ' . $to_month .' '. $to_year  ?> </strong></h3>
    



<!--<a class="btn btn-info" href="<?= base_url('kpi/view_rating_xls/'.$target_monthcode.'/'.$target_year.'/'.$state_code)?>" >Excel</a>-->
