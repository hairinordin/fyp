...
<div class="row-fluid">
    <div class="col-lg-12">
        <ul class="nav nav-tabs" id="myTab">
            <!-- Top level Tabs-->
            <li><a href="<?= base_url('kpi/view_quarterly_achievement/1') ?>">Quarter 1</a></li>
            <li><a href="<?= base_url('kpi/view_quarterly_achievement/2') ?>">Quarter 2</a></li>
            <li><a href="<?= base_url('kpi/view_quarterly_achievement/3') ?>">Quarter 3</a></li>
            <li><a href="<?= base_url('kpi/view_quarterly_achievement/4') ?>">Quarter 4</a></li>
        </ul>
    </div>
</div> 
<br>
...
<h3>Quarterly KPI Achievement - Field Inspection Quarter <?= $target_quarter ?><small> Negeri <?= $negeri ?></small></h3>
...
//      echo '</pre>';
    ...
    <form class="tr" method="post" action="<?= base_url('kpi/set_fi/'.$target_quarter) ?>">
            ...
            <?php if(isset($quarterly_kpi_kks->fi)){ ?>
            <div class="td" style="background-color: #4271f4"><input type='text' name="fi" size="4" value="<?=$quarterly_kpi_kks->fi ?>" disabled></div>
            <?php } else {?>
            <div class="td" style="background-color: #4271f4"><input type='text' name="fi" size="4" value="" required><input type="submit" value="set"></div>
            <?php } ?>
            <div class="td"><?= isset($quarterly_kpi_kks->sl) ? $quarterly_kpi_kks->sl : '<i class="fa fa-ban" title="Not set"></i>' ?></div>
    ...
    <form class="tr" method="post" action="<?= base_url('kpi/set_fi/'.$target_quarter) ?>">
        ...
        <div class="td"><?= isset($quarterly_kpi_kg->sp) ? $quarterly_kpi_kg->sp : '<i class="fa fa-ban" title="Not set"></i>t' ?></div>
        <div class="td"><?= isset($bp_kg) ? $bp_kg : '<i class="fa fa-ban" title="Not set"></i>' ?></div>
        <?php if(isset($quarterly_kpi_kg->fi)){ ?>
        <div class="td" style="background-color: #4271f4"><input type='text' name="fi" size="4" value="<?=$quarterly_kpi_kg->fi ?>" disabled></div>
        <?php } else {?>
        <div class="td" style="background-color: #4271f4"><input type='text' name="fi" size="4" value="" required><input type="submit" value="set"></div>
        <?php } ?>
        <div class="td"><?= isset($quarterly_kpi_kg->sl) ? $quarterly_kpi_kg->sl : '<i class="fa fa-ban" title="Not set"></i>' ?></div>
    ...
    <form class="tr" method="post" action="<?= base_url('kpi/set_fi/'.$target_quarter) ?>">
        ...
        <?php if(isset($quarterly_kpi_bt->fi)){ ?>
        <div class="td" style="background-color: #4271f4"><input type='text' name="fi" size="4" value="<?=$quarterly_kpi_bt->fi ?>" disabled></div>
        <?php } else {?>
        <div class="td" style="background-color: #4271f4"><input type='text' name="fi" size="4" value="" required><input type="submit" value="set"></div>
        <?php } ?>
        <div class="td"><?= isset($quarterly_kpi_bt->sl) ? $quarterly_kpi_bt->sl : '<i class="fa fa-ban" title="Not set"></i>' ?></div>
...
//      echo '</pre>';
        ...
        <form class="tr" method="post" action="<?= base_url('kpi/set_fi/'.$target_quarter) ?>">
            ...
            <?php if(isset($quarterly_kpi->fi)){ ?>
            <div class="td" style="background-color: #4271f4"><input type='text' name="fi" size="4" value="<?=$quarterly_kpi->fi ?>" disabled></div>
            <?php } else {?>
            <div class="td" style="background-color: #4271f4"><input type='text' name="fi" size="4" value="" required><input type="submit" value="set"></div>
            <?php } ?>
...
<!---DESKTOP --->
<h3>Quarterly KPI Achievement - Desktop Quarter <?= $target_quarter ?><small> Negeri <?= $negeri ?></small></h3>
<div class='table table-bordered table-striped'>
    <div class="thead">
        <div class="tr">
            <div class="td">PYDT</div>
...
?>
    <form class="tr" method="post" action="<?= base_url('kpi/set_bpdsp/'.$target_quarter) ?>">
        ...
        <div class="td">KKS</div>
            ...
            <?php if(isset($quarterly_kpi_kks->bpdsp)){ ?>
            <div class="td" style="background-color: #4271f4"><input type='text' name="bpdsp" size="4" value="<?=$quarterly_kpi_kks->bpdsp ?>" disabled></div>
            <?php } else {?>
            <div class="td" style="background-color: #4271f4"><input type='text' name="bpdsp" size="4" value="" required><input type="submit" value="set"></div>
            <?php } ?>
            <div class="td"><?= isset($quarterly_kpi_kks->sd) ? $quarterly_kpi_kks->sd : '<i class="fa fa-ban" title="Not set"></i>' ?></div>
    ...
    <form class="tr" method="post" action="<?= base_url('kpi/set_bpdsp/'.$target_quarter) ?>">
        ...
        <?php if(isset($quarterly_kpi_kg->bpdsp)){ ?>
        <div class="td" style="background-color: #4271f4"><input type='text' name="bpdsp" size="4" value="<?=$quarterly_kpi_kg->bpdsp ?>" disabled></div>
        <?php } else {?>
        <div class="td" style="background-color: #4271f4"><input type='text' name="bpdsp" size="4" value="" required><input type="submit" value="set"></div>
        <?php } ?>
        <div class="td"><?= isset($quarterly_kpi_kg->sd) ? $quarterly_kpi_kg->sd : '<i class="fa fa-ban" title="Not set"></i>' ?></div>
    ...
    <form class="tr" method="post" action="<?= base_url('kpi/set_bpdsp/'.$target_quarter) ?>">
        ...
        <?php if(isset($quarterly_kpi_bt->bpdsp)){ ?>
        <div class="td" style="background-color: #4271f4"><input type='text' name="bpdsp" size="4" value="<?=$quarterly_kpi_bt->bpdsp ?>" disabled></div>
        <?php } else {?>
        <div class="td" style="background-color: #4271f4"><input type='text' name="bpdsp" size="4" value="" required><input type="submit" value="set"></div>
        <?php } ?>
        <div class="td"><?= isset($quarterly_kpi_bt->sd) ? $quarterly_kpi_bt->sd : '<i class="fa fa-ban" title="Not set"></i>' ?></div>
...
<?php foreach ($list_of_sic as $sic): ?>   
    <?php
        ...
        <form class="tr" method="post" action="<?= base_url('kpi/set_bpdsp/'.$target_quarter) ?>">
            ...
            <?php if(isset($quarterly_kpi->bpdsp)){ ?>
            <div class="td" style="background-color: #4271f4"><input type='text' name="bpdsp" size="4" value="<?=$quarterly_kpi->bpdsp ?>" disabled></div>
            <?php } else {?>
            <div class="td" style="background-color: #4271f4"><input type='text' name="bpdsp" size="4" value="" required><input type="submit" value="set"></div>
            <?php } ?>
            <div class="td"><?= isset($quarterly_kpi->sd)? $quarterly_kpi->sd : '<i class="fa fa-ban" title="Not set"></i>'  ?></div>
