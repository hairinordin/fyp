                    ...
                    <table  class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <label class="radio-inline"><input type="radio" name="tool1-1" value="Yes"<?=($arr['tool1-1']=='Yes') ? 'checked':'disabled'?>>Yes</label>
                                <label class="radio-inline"><input type="radio" name="tool1-1" value="No"<?=($arr['tool1-1']=='No') ? 'checked':'disabled'?>>No</label>
                        ...
                        <tr>
                            ...
                            <td>
                                <label class="radio-inline"><input type="radio" name="tool1-2" value="Yes"<?=($arr['tool1-2']=='Yes') ? 'checked':'disabled'?>>Yes</label>
                                <label class="radio-inline"><input type="radio" name="tool1-2" value="No"<?=($arr['tool1-2']=='No') ? 'checked':' disabled'?>>No</label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <label class="radio-inline"><input type="radio" name="tool1-3" value="Yes"<?=($arr['tool1-3']=='Yes') ? 'checked':' disabled'?>>Yes</label>
                                <label class="radio-inline"><input type="radio" name="tool1-3" value="No"<?=($arr['tool1-3']=='No') ? 'checked':' disabled'?>>No</label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <label class="radio-inline"><input type="radio" name="tool1-4" value="Yes"<?=($arr['tool1-4']=='Yes') ? 'checked':' disabled'?>>Yes</label>
                                <label class="radio-inline"><input type="radio" name="tool1-4" value="No"<?=($arr['tool1-4']=='No') ? 'checked':' disabled'?>>No</label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <label class="radio-inline"><input type="radio" name="tool1-5" value="Yes"<?=($arr['tool1-5']=='Yes') ? 'checked':' disabled'?>>Yes</label>
                                <label class="radio-inline"><input type="radio" name="tool1-5" value="No"<?=($arr['tool1-5']=='No') ? 'checked':' disabled'?>>No</label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <label class="radio-inline"><input type="radio" name="tool1-6" value="Yes"<?=($arr['tool1-6']=='Yes') ? 'checked':'disabled '?>>Yes</label>
                                <label class="radio-inline"><input type="radio" name="tool1-6" value="No"<?=($arr['tool1-6']=='No') ? 'checked':' disabled'?>>No</label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <label class="radio-inline"><input type="radio" name="tool1-7" value="Yes"<?=($arr['tool1-7']=='Yes') ? 'checked':'disabled '?>>Yes</label>
                                <label class="radio-inline"><input type="radio" name="tool1-7" value="No"<?=($arr['tool1-7']=='No') ? 'checked':' disabled'?>>No</label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <label class="radio-inline"><input type="radio" name="tool1-8" value="Yes"<?=($arr['tool1-8']=='Yes') ? 'checked':'disabled '?>>Yes</label>
                                <label class="radio-inline"><input type="radio" name="tool1-8" value="No"<?=($arr['tool1-8']=='No') ? 'checked':' disabled'?>>No</label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <label class="radio-inline"><input type="radio" name="tool1-9" value="Yes"<?=($arr['tool1-9']=='Yes') ? 'checked':'disabled '?>>Yes</label>
                                <label class="radio-inline"><input type="radio" name="tool1-9" value="No"<?=($arr['tool1-9']=='No') ? 'checked':'disabled '?>>No</label>
                            </td>
                        </tr>
                    </table>
